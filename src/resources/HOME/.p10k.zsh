...
typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(status command_execution_time)
  ...
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_PREFIX='%057F ╭─'
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_PREFIX='%057F ├─'
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%057F ╰─'
  ...
  typeset -g POWERLEVEL9K_EMPTY_LINE_LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL= # '%057F─ %021F %034F %220F %208F %196F %201F::'
  ...
  # typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION='%233F'
  typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION='%233F  '
  ...
  typeset -g POWERLEVEL9K_DIR_MAX_LENGTH=0 # 80
  ...
  #   typeset -g POWERLEVEL9K_DIR_WORK_VISUAL_IDENTIFIER_EXPANSION='⭐'
    ...
    typeset -g POWERLEVEL9K_DIR_WORK_FOREGROUND=233 # 31
    typeset -g POWERLEVEL9K_DIR_WORK_SHORTENED_FOREGROUND=233 # 103
    typeset -g POWERLEVEL9K_DIR_WORK_ANCHOR_FOREGROUND=233 # 39
  #
  #   # Styling for WORK_NOT_WRITABLE.
  #   typeset -g POWERLEVEL9K_DIR_WORK_NOT_WRITABLE_VISUAL_IDENTIFIER_EXPANSION='⭐'
    typeset -g POWERLEVEL9K_DIR_WORK_NOT_WRITABLE_BACKGROUND=4
    typeset -g POWERLEVEL9K_DIR_WORK_NOT_WRITABLE_FOREGROUND=233 # 31
    typeset -g POWERLEVEL9K_DIR_WORK_NOT_WRITABLE_SHORTENED_FOREGROUND=233 # 103
    typeset -g POWERLEVEL9K_DIR_WORK_NOT_WRITABLE_ANCHOR_FOREGROUND=233 # 39
  #
...
#   typeset -g POWERLEVEL9K_VCS_LOADING_BACKGROUND=8
  ...
  function my_git_formatter() {
    ...
    local       meta='%233F' # white foreground 7F
    local      clean='%233F' # black foreground 0F
    local   modified='%233F' # black foreground 0F
    local  untracked='%233F' # black foreground 0F
    local conflicted='%233F' # red foreground   1F
...
#   typeset -g POWERLEVEL9K_ASDF_PYTHON_BACKGROUND=4
  ...
  typeset -g POWERLEVEL9K_ASDF_GOLANG_FOREGROUND=
