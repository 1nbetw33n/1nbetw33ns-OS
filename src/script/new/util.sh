...
# function to convert a hex color that is provided as argument in the format #RRGGBB to the format (R,G,B, 1.)
...
# function to convert a hex color that is provided as argument in the format #RRGGBB to the format (.xxxx, .xxxx, .xxxx, 1.)
